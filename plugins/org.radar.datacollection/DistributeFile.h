...
protected:
     ...
     */
    bool sendToDir(const char *fullPath, KeyIv &keyiv, TransTask &task, int userIndex);
    bool sendToFtp(const char *fullPath, KeyIv &keyiv, TransTask &userInfo, int userIndex);
