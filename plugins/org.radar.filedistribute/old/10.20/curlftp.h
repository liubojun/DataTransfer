...
signals:
    void progress(int id, qint64 dltotal, qint64 dlnow, qint64 ultotal, qint64 ulnow);
public:
    void emitProgress(CURL *curl, qint64 dltotal, qint64 dlnow, qint64 ultotal, qint64 ulnow);
//     {
